...
--
-- Host: 127.0.0.1
-- Generation Time: 28-Jun-2016 às 18:04
...
--
-- Extraindo dados da tabela `app_empresas`
--
...
`idAtendimento` int(11) NOT NULL,
  `data` varchar(12) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
  `hora` varchar(45) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
  `usuario` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
  `contato` varchar(100) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
  `ocorrencia` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
  `categoria_idCat` int(11) NOT NULL,
  `ws_users_user_id` int(11) NOT NULL
...
INSERT INTO `atendimento` (`idAtendimento`, `data`, `hora`, `usuario`, `contato`, `ocorrencia`, `categoria_idCat`, `ws_users_user_id`) VALUES
(4, '19/06/2016', '23:13', 'Andrea Biscione', '1234 5678', '<p>wwww teste de atualiza&ccedil;&atilde;o</p>', 2, 2),
(5, '18/06/2016', '10:25', 'teste', '11112222', '<p>qqq</p>', 5, 2),
(6, '18/06/2016', '10:26', 'Fernanda Samu', '1234 5678', '<p>ert</p>', 2, 2),
(9, '18/06/2016', '10:33', 'Naia', '4444', '<p>qqqq</p>', 2, 2),
(10, '21/06/2016', '19:44', 'Mirela linda', '12345678', '<p>teste do sistema</p>', 5, 3),
(11, '21/06/2016', '19:54', 'joao', '3412', '<p>problemas diversos de impress&atilde;o</p>', 1, 3);
...
(1, 'Impressora'),
(2, 'Suporte ao usuÃ¡rio'),
(3, 'AtualizaÃ§Ã£o/FormataÃ§Ã£o'),
(5, 'hardware');
...
(2, 'Diego', 'Cintra', 'diegocintra@franca.sp.gov.br', 'e10adc3949ba59abbe56e057f20f883e', '2016-06-18 04:07:34', '0000-00-00 00:00:00', 3),
(3, 'Pedro', 'Borges', 'pedroborges@franca.sp.gov.br', 'e10adc3949ba59abbe56e057f20f883e', '2016-06-18 18:51:50', '0000-00-00 00:00:00', 3),
(4, 'Pedro', 'Garcia', 'pedrogarcia@franca.sp.gov.br', 'e10adc3949ba59abbe56e057f20f883e', '2016-06-18 18:53:39', '0000-00-00 00:00:00', 3),
(5, 'Jonatas', 'Ubiali', 'jonatasubiali@franca.sp.gov.br', 'e10adc3949ba59abbe56e057f20f883e', '2016-06-18 18:54:56', '0000-00-00 00:00:00', 3);
...
ALTER TABLE `atendimento`
 ADD PRIMARY KEY (`idAtendimento`,`categoria_idCat`,`ws_users_user_id`), ADD KEY `fk_atendimento_categoria_idx` (`categoria_idCat`), ADD KEY `fk_atendimento_usuarios1_idx` (`ws_users_user_id`);
...
--
ALTER TABLE `atendimento`
ADD CONSTRAINT `fk_atendimento_categoria` FOREIGN KEY (`categoria_idCat`) REFERENCES `categoria` (`idCat`) ON DELETE NO ACTION ON UPDATE NO ACTION,
ADD CONSTRAINT `fk_atendimento_usuarios1` FOREIGN KEY (`ws_users_user_id`) REFERENCES `ws_users` (`user_id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
