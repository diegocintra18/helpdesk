<div class="table-responsive">
    <div class="panel panel-primary">
        <div class="panel-heading">Consulta de atendimentos</div>
        <div class="panel-body">
            <table class="table table-hover table-bordered table-condensed">
                ...
                <tbody>
                    ...
                    //Executa a consulta
                    $readConsulta->ExeRead("atendimentos a", "INNER JOIN categorias c on a.categorias_ct_idcategoria = c.ct_idcategoria INNER JOIN usuarios u on a.usuarios_us_idUser = u.us_idUser ORDER BY at_data DESC LIMIT 600");
                    ...
                    foreach ($readConsulta->getResult() as $consulta):
                        ...
                        echo "<td> {$consulta['at_users']}</td>";
                        echo "<td> {$consulta['at_contato']}</td>";
                        echo "<td> {$consulta['at_ocorrencia']}</td>";
                        echo "<td> {$consulta['ct_categoria']} </td>";
